Simulator for C. elegans somatic system network (279 neurons). Whole code structure and single scripts function can be checked in the outline of "simulator.jpg" (figure 1). 
